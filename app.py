...
def getTracks():
    ...
    return render_template('news.html', user_display_name=current_user_name, images=images, short_term=short_term, medium_term=medium_term, long_term=long_term, currentTime=gmtime())
